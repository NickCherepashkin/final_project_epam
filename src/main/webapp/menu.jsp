...
<nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand" href="#page-top"><img class="logo" src="images/logo.png" alt="Sherlock"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="index.jsp">${text_home}</a></li>
                <c:if test="${user.idRole != 1}">
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="catalog?command=get_book_list">${text_catalog}</a></li>
                </c:if>
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="aboutUs">${text_about}</a></li>
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="contactUs">${text_contact}</a></li>
                <c:if test="${user == null}">
                <li class="nav-item mx-0 mx-lg-1"><a id="signUp" class="nav-link py-3 px-0 px-lg-3 rounded" href="login.jsp">${text_login}</a></li>
                </c:if>
                <c:if test="${user != null}">
