...
public class ReqParam {
    ...
    public static final String CONFIRM_PASSWORD = "re_pass";
    ...
    public static final String GENRES_LIST = "genresList";
    public static final String BOOKS_LIST = "bookList";
    public static final String USERS_LIST = "usersList";
    public static final String NOVELTIES_LIST = "noveltyList";
